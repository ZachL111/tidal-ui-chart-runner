...
tidal-ui-chart-runner is a Lua project for frontend apps. It focuses on this technical goal: Develop a Lua command-oriented project for chart scenarios with deny and allow fixtures, explainable decision traces, and synthetic fixtures only.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 154, risk penalty 7, latency penalty 4, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
