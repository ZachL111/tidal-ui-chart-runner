"""Regression checks for the tidal-ui-chart-runner casebook."""
...
from casebook.harness import assert_expected, tidal_ui_chart_runner_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tidal_ui_chart_runner_summary(), assert_expected())
